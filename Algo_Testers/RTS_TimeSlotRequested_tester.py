...
combined = list(
    zip(RTS_timeSlots_requested, UEID_requested, dataRates_requested, propDelay_forRequest, timeStamp_forRequest)
)
...
RTS_timeSlots_requested, UEID_requested, dataRates_requested, propDelay_forRequest, timeStamp_forRequest = zip(
    *combined_sorted
)
