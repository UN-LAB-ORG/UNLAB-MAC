...
class MAC_Controller:
    ...
    def setupMAC(self,numAP, lambda_density, beamWidth,UE_BeamWidth, UE_Power, AP_Power,frequency, UE_uplinkTransmissionRate,startTime,simEndTime,logger:Logger,ue_coordinates,mirrors):
        self.setup_devices(numAP, lambda_density, beamWidth,UE_BeamWidth, UE_Power, AP_Power,frequency, UE_uplinkTransmissionRate,startTime,simEndTime,ue_coordinates)
    ...
    def setup_devices(self, numAP, lambda_density, beamWidth,UE_BeamWidth, UE_Power, AP_Power,frequency, UE_uplinkTransmissionRate,startTime,simEndTime,fixed_ue_coordinates):
        #Top Function to Setup the UE Device handset and AP
        AP_RFBox, UE_RFBox = self.setup_RFEquipment(beamWidth,UE_BeamWidth, UE_Power, AP_Power, frequency) # get the gain of the system. 
